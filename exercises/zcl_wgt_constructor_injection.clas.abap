class ZCL_WGT_CONSTRUCTOR_INJECTION definition
  public
  final
  create public .
...
CLASS ZCL_WGT_CONSTRUCTOR_INJECTION IMPLEMENTATION.


  METHOD get_amount_in_coins.
    DATA(cash_provider) = CAST ZIF_WGT_CASH_PROVIDER( NEW ZCL_WGT_CASH_PROVIDER( ) ).
