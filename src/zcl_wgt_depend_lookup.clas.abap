class ZCL_WGT_DEPEND_LOOKUP definition
  public
  final
  create public .
...
CLASS ZCL_WGT_DEPEND_LOOKUP IMPLEMENTATION.


  METHOD get_amount_in_coins.
    DATA(cash_provider) = CAST ZIF_WGT_CASH_PROVIDER( NEW ZCL_WGT_CASH_PROVIDER_MANAGED( ) ).
